...
frame:SetScript("OnEvent", function(_, eventName, ...)
    if eventName == "PLAYER_LOGIN" then
        -- Ensure that Init is called before any access to positionAnchor
        PvPAssistant.ARENA_QUICK_JOIN:Init() -- Initialize Arena Quick Join

        -- Rest of the PLAYER_LOGIN logic goes here...
        -- The button setup and other logic
    end

    -- Handle other events, such as ADDON_LOADED, GROUP_ROSTER_UPDATE, etc.
end)
